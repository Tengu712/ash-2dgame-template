...
fn create_pipeline_layout(
    ...
    unsafe {
        device
            ...
            .expect_log("failed to create a pipeline layout")
    }
}
...
fn create_pipeline(
    ...
    let pipeline = match pipelines {
        ...
        _ => panic_log("failed to create a pipeline"),
    };
...
fn create_shader_module(device: &Device, spv_bin: &[u8]) -> vk::ShaderModule {
    let code = spv_bin
        .chunks_exact(4)
    ...
    unsafe {
        device
            ...
            .expect_log("failed to create a shader module")
    }
}
